...
export const THEMES: Record<ThemeId, Theme> = {
    "neon-glass": {
        ...
        tokens: {
            "--bg": "#04120c",
            "--bg-elev": "rgba(120,255,200,0.05)",
            "--bg-elev-2": "rgba(120,255,200,0.09)",
            "--border": "rgba(140,255,210,0.14)",
            "--fg": "#eafff5",
            "--fg-dim": "rgba(234,255,245,0.55)",
            "--accent": "#00e08a",
            "--accent-2": "#19ffd5",
            "--accent-deck-a": "#19ffd5",
            "--accent-deck-b": "#ff5d9e",
            "--good": "#3ddc97",
            "--warn": "#ffb020",
            "--danger": "#ff4d6d",
            "--card-radius": "18px",
