...
const ro = {
    ...
    "home.songs": "{n} piese",
    "home.play": "Redă",
    "home.whereToWatch": "Unde vezi",
    "home.inLibrary": "În bibliotecă",
    "home.mediaUnavailable": "Recomandările nu sunt disponibile pe acest server.",
    "home.heroMeta.movie": "Film",
    "home.heroMeta.tv": "Serial",

    // Title
    "title.play": "Redă",
    "title.playFrom": "Redă de pe {server}",
    "title.resumeFrom": "Continuă de la {time}",
    "title.sources": "Surse",
    "title.whereToWatch": "Unde vezi",
    "title.noOffers": "Nicio ofertă de streaming găsită pentru {region}.",
    "title.markWatched": "Marchează văzut",
    "title.watched": "Văzut ✓",
    "title.installed": "instalat",
    "title.notInstalled": "neinstalat",
    "title.offer.subscription": "abonament",
    "title.offer.rent": "închiriere",
    "title.offer.buy": "cumpărare",
    "title.offer.free": "gratuit",
    "title.offer.ads": "cu reclame",
    "title.seasons": "{n} sezoane",
    "title.episodesCount": "{n} episoade",
    "title.runtime": "{n} min",
    "title.launching": "Se deschide {name}…",
    "title.launchedBrowser": "Deschis în browser.",
    "title.launchQr": "Aplicația {name} nu poate fi deschisă pe acest TV. Scanează codul pentru a continua pe telefon.",
    "title.attribution": "Date: {sources}",
    "title.similar": "Titluri similare",
    "title.recommended": "Recomandate",
    "title.episode": "S{s}E{e}",
...
const en: Record<MessageKey, string> = {
    ...
    "home.inLibrary": "In library",
    "home.mediaUnavailable": "Recommendations are not available on this server.",
    "home.heroMeta.movie": "Movie",
    "home.heroMeta.tv": "TV show",

    "title.play": "Play",
    "title.playFrom": "Play from {server}",
    "title.resumeFrom": "Resume from {time}",
    "title.sources": "Sources",
    "title.whereToWatch": "Where to watch",
    "title.noOffers": "No streaming offers found for {region}.",
    "title.markWatched": "Mark as watched",
    "title.watched": "Watched ✓",
    "title.installed": "installed",
    "title.notInstalled": "not installed",
    "title.offer.subscription": "subscription",
    "title.offer.rent": "rent",
    "title.offer.buy": "buy",
    "title.offer.free": "free",
    "title.offer.ads": "with ads",
    "title.seasons": "{n} seasons",
    "title.episodesCount": "{n} episodes",
    "title.runtime": "{n} min",
    "title.launching": "Opening {name}…",
    "title.launchedBrowser": "Opened in the browser.",
    "title.launchQr": "The {name} app cannot be opened on this TV. Scan the code to continue on your phone.",
    "title.attribution": "Data: {sources}",
    "title.similar": "Similar titles",
