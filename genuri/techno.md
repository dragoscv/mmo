...
```mermaid
graph TD
    TECHNO["🖤 Techno"] --> DTECH["Deep Techno<br/>125-130 BPM<br/>ambient, atmosferic"]
    TECHNO --> PEAK["Peak Time<br/>130-140 BPM<br/>agresiv, mare energie"]
    TECHNO --> HARD["Hard Techno<br/>140-150 BPM<br/>industrial, raw"]
    TECHNO --> MIN["Minimal Techno<br/>125-132 BPM<br/>stripped, percusiv"]
    TECHNO --> MELO["Melodic Techno<br/>128-133 BPM<br/>emoțional, pads"]
    
    style PEAK fill:#ef4444,stroke:#dc2626,color:#fff
    style HARD fill:#7c3aed,stroke:#6d28d9,color:#fff
```
