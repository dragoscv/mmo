...
graph TD
    M["🎤 Manele"]
    M --> BPM["⚠️ BPM Variabil<br/>Tempo se schimbă în track"]
    M --> KEY["⚠️ Scale Orientale<br/>Camelot nu funcționează perfect"]
    M --> STRUCT["⚠️ Structură Non-Standard<br/>Nu e 4/4 simplu mereu"]
    M --> VOCAL["⚠️ Vocals Dominante<br/>Nu poți suprapune 2 voci"]
    
    style BPM fill:#ef4444,stroke:#dc2626,color:#fff
    style KEY fill:#fb923c,stroke:#ea580c,color:#000
    style STRUCT fill:#facc15,stroke:#ca8a04,color:#000
    style VOCAL fill:#60a5fa,stroke:#2563eb,color:#000
```
