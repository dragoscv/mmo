...
export function NowPlaying() {
    ...
    const { currentTrack, isPlaying, currentTime, duration, volume, queue, queueIndex } = player;
                        ...
                        <div className="flex-1 overflow-y-auto">
                            {activeTab === "queue" ? (
                                <div className="p-2">
                                    ...
                                    {upNext.length === 0 && recommendations.length === 0 && (
                                    ...
                                    {currentTrack.comment ? (
                                        ...
                                        <div className="text-center text-white/30">
                                            ...
                                            <p className="text-xs mt-1">
                                                Lyrics can be added in the track&apos;s comment field
                                            </p>
                                        </div>
                                    )}
                                </div>
