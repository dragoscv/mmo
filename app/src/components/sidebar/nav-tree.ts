...
export const navTree: NavNode[] = [
    ...
    },
    {
        ...
        children: [
            { kind: "leaf", key: "watch-browse", href: "/watch", label: "Browse", icon: Clapperboard, exact: true },
            { kind: "leaf", key: "collections", href: "/watch/collections", label: "Collections", icon: Library },
            { kind: "leaf", key: "profiles", href: "/profiles", label: "Profiles", icon: UserCircle },
        ],
    },
    {
