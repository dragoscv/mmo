...
gantt
    ...
    section Săptămâna dinainte
    Finalizare playlist          :a1, 0, 2
    Test tranziții (Dual Players):a2, 2, 4
    Export USB (2×)              :a3, 4, 5
    
    section Ziua dinainte
    Verificare USB pe echipament :b1, 5, 6
    Backup USB                   :b2, 6, 7
    Pregătire bag (cabluri etc.) :b3, 7, 8
    
    section Ziua gig-ului
    Verificare echipament venue  :c1, 8, 9
    Sound check (dacă e posibil):c2, 9, 10
    PERFORMANCE                  :crit, c3, 10, 13
    
    section După gig
    Save Play History            :d1, 13, 14
    Debrief & notes              :d2, 14, 15
```
