...
```mermaid
graph LR
    subgraph DUAL["💾 Export Mode — Dual Players"]
        DA["🎵 Deck A<br/>Track curent"]
        DB["🎵 Deck B<br/>Track următor"]
        DA <-->|"Preview tranziție"| DB
    end
    
    DUAL -->|"Funcționează FĂRĂ<br/>controller!"| PREP["📋 Set pregătit"]
    
    style DUAL fill:#e0f2fe,stroke:#0284c7
    style PREP fill:#4ade80,stroke:#16a34a,color:#000
```
...
```mermaid
graph LR
    subgraph SET["⏱️ Set de 1 oră"]
        W["🟢 Warmup<br/>0-15 min<br/>BPM: 120-128"] --> B["🟡 Build<br/>15-30 min<br/>BPM: 128-138"]
        B --> P["🔴 Peak<br/>30-45 min<br/>BPM: 138-150"]
        P --> C["🟣 Cooldown<br/>45-60 min<br/>BPM: 140-128"]
    end
    
    style W fill:#4ade80,stroke:#16a34a,color:#000
    style B fill:#facc15,stroke:#ca8a04,color:#000
    style P fill:#ef4444,stroke:#dc2626,color:#fff
    style C fill:#c084fc,stroke:#9333ea,color:#000
```
