...
```mermaid
graph TD
    ACUM["🟢 ACUM<br/>DDJ-FLX4 + Laptop"] -->|"USB export"| CLUB["🟡 CLUB<br/>CDJ/XDJ + USB"]
    ACUM -->|"upgrade"| UPGRADE["🔴 UPGRADE<br/>DDJ-1000 / DDJ-FLX10"]
    
    style ACUM fill:#4ade80,stroke:#16a34a,color:#000
    style CLUB fill:#facc15,stroke:#ca8a04,color:#000
    style UPGRADE fill:#ef4444,stroke:#dc2626,color:#fff
```
