...
```mermaid
graph TD
    A["🔍 1. DESCOPERIRE<br/>Găsești muzică nouă"] --> B["📥 2. ACHIZIȚIE<br/>Download/Cumpărare"]
    B --> C["📂 3. INGEST<br/>Mută în H:\Music\_Inbox"]
    C --> D["🔬 4. ANALIZĂ<br/>Import RB + auto-analyze"]
    D --> E["🏷️ 5. CLASIFICARE<br/>Taguri, gen, energie, mood"]
    E --> F["🎯 6. PREGĂTIRE<br/>Cue points, loops, grid"]
    F --> G["📋 7. SET BUILDING<br/>Playlisturi ordonate"]
    G --> H["🧪 8. TESTARE<br/>Dual Players, practice"]
    H --> I["💾 9. EXPORT<br/>USB + backup"]
    I --> J["🎧 10. PERFORMANCE<br/>Gig / Live set"]
    J --> K["📊 11. REVIEW<br/>History, feedback, improve"]
    K -->|"ciclu"| A
    
    style A fill:#60a5fa,stroke:#2563eb,color:#000
    style F fill:#facc15,stroke:#ca8a04,color:#000
    style J fill:#ef4444,stroke:#dc2626,color:#fff
    style K fill:#c084fc,stroke:#9333ea,color:#000
```
