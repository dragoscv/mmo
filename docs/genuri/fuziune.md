...
```mermaid
graph TD
    TH["Tech House<br/>🟢 Warmup"] --> TECH["Techno<br/>🟡 Build"]
    TECH --> ACID["Acid<br/>🟡 Build"]
    ACID --> PSY["Psytrance<br/>🔴 Peak"]
    PSY --> BOU["Bounce<br/>🔴 Peak"]
    BOU -->|"BREAK"| MAN["Manele<br/>🟡 Party"]
    MAN --> BALK["Balkanică<br/>🟡 Party"]
    BALK --> LAT["Latino<br/>🟡 Groove"]
    LAT -->|"BREAK"| TECH2["Techno<br/>🟡 Return"]
    TECH2 --> ACID2["Acid<br/>🔴 Final Peak"]
    ACID2 --> TH2["Tech House<br/>🟢 Closing"]
    
    style TH fill:#4ade80,stroke:#16a34a,color:#000
    style PSY fill:#ef4444,stroke:#dc2626,color:#fff
    style BOU fill:#ef4444,stroke:#dc2626,color:#fff
    style MAN fill:#facc15,stroke:#ca8a04,color:#000
    style TH2 fill:#4ade80,stroke:#16a34a,color:#000
```
