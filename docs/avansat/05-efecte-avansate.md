...
```mermaid
graph TD
    FX["🎛️ Efecte Rekordbox"] --> BEAT["Beat FX<br/>Sincronizate cu BPM"]
    FX --> COLOR["Sound Color FX<br/>Un knob per canal"]
    FX --> PAD["Pad FX<br/>De pe performance pads"]
    FX --> SMART["Smart CFX<br/>✨ Feature DDJ-FLX4"]
    ...
    style FX fill:#667eea,stroke:#764ba2,color:#fff
    style SMART fill:#fb923c,stroke:#ea580c,color:#000
```
