...
```mermaid
graph TD
    subgraph NOW["✅ CE AI ACUM"]
        DDJ["🎛️ DDJ-FLX4"]
        CT["🎹 Circuit Tracks"]
        MIDI["🎹 MIDI Keyboard (vărul)"]
        LAPTOP["💻 Laptop"]
        PHONES["🎧 Căști"]
    end
    
    subgraph NEXT["🔜 URMĂTORUL UPGRADE"]
        MONITOR["🔊 Monitor Speakers<br/>KRK Rokit 5"]
        MIXER_EXT["🎚️ Mixer Extern<br/>(pentru CT audio in)"]
    end
    
    subgraph FUTURE["⏳ VIITOR"]
        DDJ1000["🎛️ DDJ-1000<br/>4 canale, jogs mari"]
        INTERFACE["🎚️ Audio Interface<br/>Focusrite Scarlett"]
        XDJ["📦 XDJ-RX3<br/>Standalone"]
    end
    
    subgraph PRO["🏆 SETUP CLUB"]
        CDJ["📀 2× CDJ-3000"]
        DJM["🎚️ DJM-900NXS2"]
    end
    ...
    style NOW fill:#4ade80,stroke:#16a34a,color:#000
    style NEXT fill:#facc15,stroke:#ca8a04,color:#000
    style FUTURE fill:#60a5fa,stroke:#2563eb,color:#000
    style PRO fill:#a78bfa,stroke:#7c3aed,color:#000
```
