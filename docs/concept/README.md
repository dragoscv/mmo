...
| **Browser Extension** ([`extension/`](../../apps/extension/)) | "One-click capture" din 15+ platforme streaming în bibliotecă | Curatori, crate-diggeri, oameni care descoperă tracks online |
